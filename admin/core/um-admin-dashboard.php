 ...
 * Changes include:
 *
 * egifford 2015_09_03: Strange incompatibility with wp-views. Patched menu enumeration in menu_order_count().
 */
...
// BEGIN egifford 2015_09_03: Strange incompatibility with wp-views. Patched menu enumeration in menu_order_count().
    if ( ! empty( $menu ) ) {
    ...
    if ( ! empty( $submenu ) && ! empty( $submenu['users.php'] ) ) {
